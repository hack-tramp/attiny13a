...
.dseg
.org SRAM_START
msg:	.byte	8	; text to be transmitted, stored in ram
.cseg
...
ldi	ZH,HIGH(msg)	; to rx buffer address
...
Rx_Byte:       sbic  RXPORT,  UART_RX  ; //  START bit detector          //
        ...
        ldi   r19,0b11111111            ; //  Set Bits counter  mask to 0b11111111    //
Delay_Rx:     
